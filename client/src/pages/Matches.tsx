...
export default function Matches() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-16 md:pb-0">
      ...
      {/* Header Section */}
      <section className="bg-gradient-to-br from-royal-blue to-blue-800 text-white py-8 sm:py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-poppins font-bold mb-3 sm:mb-4 leading-tight">
              My <span className="text-gold">Matches</span>
            </h1>
            <p className="text-base sm:text-lg text-blue-100 mb-4 sm:mb-6 max-w-2xl mx-auto leading-relaxed">
      ...
      <section className="py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Account Type Badge - only show for authenticated users */}
          {firebaseUser && (
            ...
            <div className="text-center py-12">
              <div className="max-w-md mx-auto">
                ...
                <p className="text-gray-600 mb-6">
                  Sign in to view your matches and connect with people who are interested in you.
                </p>
          ...
          {/* Tabs and Content - only show for authenticated users */}
          {firebaseUser && (
            <>
              {/* Tabs */}
              <div className="flex justify-center mb-6">
